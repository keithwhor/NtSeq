var Nt = function() {
  ...
  function MatchMap(query, searchSpace, offset) {
    ...
    this.__offset = offset === undefined ? null : Math.max(0, offset | 0);
  ...
  MatchMap.prototype.sort = function() {
    ...
    this.__orderedResults = this.__results.slice().sort(function(a, b) { return b.s - a.s; });
  ...
  MatchMap.prototype.top = function(n) {
    ...
    return this.__orderedResults.slice(0, n).map(function(v) {
      return new MatchResult(self, v.n, v.s);
    });
